  ...
  if (!flow) {
    return (
      <div className="flex flex-col items-center space-y-4">
        <button className="bg-brand-pink text-white py-2 px-6 rounded-lg font-semibold" onClick={() => setFlow('videogame')}>Un Videojuego</button>
        <button className="bg-brand-card text-text-muted py-2 px-6 rounded-lg font-semibold" onClick={() => setFlow('brand')}>Una Marca</button>
      </div>
    );
  }
  ...
  return (
    <form className="space-y-8" onSubmit={handleSubmit}>
      ...
      <div className="flex justify-between mt-8">
        <button type="button" className="bg-brand-card text-text-muted py-2 px-6 rounded-lg font-semibold" onClick={handlePrev} disabled={step === 0}>Anterior</button>
        {step < 3 ? (
          <button type="button" className="bg-brand-pink text-white py-2 px-6 rounded-lg font-semibold" onClick={handleNext}>Siguiente</button>
        ) : (
          <button type="submit" className="bg-brand-purple text-white font-bold py-3 px-8 rounded-lg" disabled={submitting}>Enviar Propuesta</button>
        )}
      </div>
